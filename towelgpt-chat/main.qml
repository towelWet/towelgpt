...
Window {
    ...
    minimumHeight: 480
    visible: true
    title: qsTr("towelgpt v") + Qt.application.version
    ...
    PopupDialog {
        ...
        text: qsTr("<h3>Encountered an error loading model:</h3><br>")
            ...
            + "<li>Read more about what models are supported in our <a href=\"https://docs.gpt4all.io/towelgpt_chat.html\">documentation</a> for the gui"
    ...
    MyToolButton {
        ...
        source: "qrc:/towelgpt/icons/network.svg"
    ...
    MyToolButton {
        ...
        source: "qrc:/towelgpt/icons/db.svg"
    ...
    MyToolButton {
        ...
        z: 200
        padding: 15
        source: "qrc:/towelgpt/icons/settings.svg"
    ...
    MyToolButton {
        ...
        z: 200
        padding: 15
        source: "qrc:/towelgpt/icons/copy.svg"
    ...
    MyToolButton {
        ...
        z: 200
        padding: 15
        source: "qrc:/towelgpt/icons/regenerate.svg"
    ...
    Rectangle {
        ...
        ScrollView {
            ...
            Rectangle {
                ...
                Text {
                    id: warningLabel
                    text: qsTr("You must install a model to continue. Models are available via the download dialog or you can install them manually by downloading from <a href=\"https://gpt4all.io\">the towelgpt website</a> (look for the Models Explorer) and placing them in the model folder. The model folder can be found in the settings dialog under the application tab.")
                    color: theme.textColor
                    font.pixelSize: theme.fontSizeLarge
                    width: 600
                ...
                MyButton {
                    ...
                    Image {
                        ...
                        height: 24
                        mipmap: true
                        source: "qrc:/towelgpt/icons/download.svg"
                    }
                    background: Rectangle {
                        ...
                        Column {
                            ...
                            Item {
                                ...
                                MyToolButton {
                                    ...
                                    source: "qrc:/towelgpt/icons/thumbs_up.svg"
                                ...
                                MyToolButton {
                                    ...
                                    source: "qrc:/towelgpt/icons/thumbs_down.svg"
        ...
        MyButton {
            ...
            Image {
                ...
                anchors.left: parent.left
                anchors.leftMargin: 15
                source: currentChat.responseInProgress ? "qrc:/towelgpt/icons/stop_generating.svg" : "qrc:/towelgpt/icons/regenerate.svg"
            }
            leftPadding: 50
            onClicked: {
        ...
        MyToolButton {
            ...
            height: 30
            visible: !currentChat.isServer
            source: "qrc:/towelgpt/icons/send_message.svg"
