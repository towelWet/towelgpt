...
When a towelgpt model responds to you and you have opted-in, your conversation will be sent to the towelgpt
Open Source Datalake. Additionally, you can like/dislike its response. If you dislike a response, you
can suggest an alternative response. This data will be collected and aggregated in the towelgpt Datalake.

NOTE: By turning on this feature, you will be sending your data to the towelgpt Open Source Datalake.
...
to download and will be used by Nomic AI to improve future towelgpt models. Nomic AI will retain all
attribution information attached to your data and you will be credited as a contributor to any towelgpt
model release that uses your data!")
        ...
        GridLayout {
            ...
            Label {
                id: optInStatistics
                text: "Opt-in to anonymous usage analytics used to improve towelgpt"
                Layout.row: 0
                Layout.column: 0
                color: theme.textColor
                font.pixelSize: theme.fontSizeLarge
            ...
            Label {
                id: optInNetwork
                text: "Opt-in to anonymous sharing of chats to the towelgpt Datalake"
                Layout.row: 1
                Layout.column: 0
                color: theme.textColor
                font.pixelSize: theme.fontSizeLarge
            ...
            RowLayout {
                ...
                RadioButton {
                    ...
                    Accessible.role: Accessible.RadioButton
                    Accessible.name: qsTr("Opt-in for network")
                    Accessible.description: qsTr("Radio button to allow opt-in anonymous sharing of chats to the towelgpt Datalake")
                ...
                RadioButton {
                    ...
                    Accessible.description: qsTr("Radio button to allow opt-out anonymous sharing of chats to the towelgpt Datalake")
