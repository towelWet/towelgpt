...
Cross platform Qt based GUI for towelgpt versions with GPT-J as the base
model. NOTE: The model seen in the screenshot is actually a preview of a
new training run for towelgpt based on GPT-J. The towelgpt project is busy
...
## License
The source code of this chat interface is currently under a MIT license. The underlying towelgpt-j model is released under non-restrictive open-source Apache 2 License.

The towelgpt-J license allows for users to use generated outputs as they see fit. Users take responsibility for ensuring their content meets applicable requirements for publication in a given context or region.
