...
import (
	...
	towelgpt "github.com/nomic-ai/gpt4all/towelgpt-bindings/golang"
)
...
func main() {
	...
	l, err := towelgpt.New(model, towelgpt.SetThreads(threads))
	if err != nil {
	...
	for {
		...
		_, err := l.Predict(text, towelgpt.SetTokens(tokens), towelgpt.SetTopK(90), towelgpt.SetTopP(0.86))
		if err != nil {
			panic(err)
		}
		fmt.Printf("\n\n")
