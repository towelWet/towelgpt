...
// #cgo CFLAGS: -I${SRCDIR}../../towelgpt-backend/ -I${SRCDIR}../../towelgpt-backend/llama.cpp -I./
// #cgo CXXFLAGS: -std=c++17 -I${SRCDIR}../../towelgpt-backend/ -I${SRCDIR}../../towelgpt-backend/llama.cpp -I./
// #cgo darwin LDFLAGS: -framework Accelerate
// #cgo darwin CXXFLAGS: -std=c++17
// #cgo LDFLAGS: -ltowelgpt -lm -lstdc++ -ldl
