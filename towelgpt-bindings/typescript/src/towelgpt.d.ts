...
interface ModelFile {
    ...
    gptj:
        | "ggml-towelgpt-j-v1.3-groovy.bin"
        | "ggml-towelgpt-j-v1.2-jazzy.bin"
        | "ggml-towelgpt-j-v1.1-breezy.bin"
        | "ggml-towelgpt-j.bin";
    /** List Llama Models */
    llama:
        | "ggml-towelgpt-l13b-snoozy.bin"
 ...
 * By default this will download a model from the official towelgpt website, if a model is not present at given path.
 *
...
/**
 * From python api:
 * models will be stored in (homedir)/.cache/towelgpt/`
 */
 ...
 *
 * @example
 * const controller = download('ggml-towelgpt-j-v1.3-groovy.bin')
...
interface DownloadController {
    /** Cancel the request to download from towelgpt website if this is called. */
    cancel: () => void;
