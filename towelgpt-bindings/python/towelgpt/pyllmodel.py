...
MODEL_LIB_PATH = str(pkg_resources.resource_filename("towelgpt", LLMODEL_PATH)).replace("\\", "\\\\")
...
def load_llmodel_library():
    ...
    llmodel_dir = str(pkg_resources.resource_filename("towelgpt", os.path.join(LLMODEL_PATH, llmodel_file))).replace(
        "\\", "\\\\"
    )
...
class LLModel:
    """
    Base class and universal wrapper for towelgpt language models
