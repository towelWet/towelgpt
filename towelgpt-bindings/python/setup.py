...
package_name = "towelgpt"

# Define the location of your prebuilt C library files
SRC_CLIB_DIRECtORY = os.path.join("..", "..", "towelgpt-backend")
SRC_CLIB_BUILD_DIRECTORY = os.path.join("..", "..", "towelgpt-backend", "build") 
...
setup(
    name=package_name,
    version="1.0.8",
    description="Python bindings for towelgpt",
    author="Richard Guo",
    author_email="richard@nomic.ai",
    url="https://pypi.org/project/towelgpt/",
    classifiers = [
