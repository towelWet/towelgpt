# towelgpt Node.js API

```sh
yarn install towelgpt@alpha
...
*   \[ ] publish to npm under alpha tag `towelgpt@alpha`
...
Type: (`"ggml-towelgpt-j-v1.3-groovy.bin"` | `"ggml-towelgpt-j-v1.2-jazzy.bin"` | `"ggml-towelgpt-j-v1.1-breezy.bin"` | `"ggml-towelgpt-j.bin"`)

##### llama

List Llama Models

Type: (`"ggml-towelgpt-l13b-snoozy.bin"` | `"ggml-vicuna-7b-1.1-q4_2.bin"` | `"ggml-vicuna-13b-1.1-q4_2.bin"` | `"ggml-wizardLM-7B.q4_2.bin"` | `"ggml-stable-vicuna-13B.q4_2.bin"` | `"ggml-nous-gpt4-vicuna-13b.bin"` | `"ggml-v3-13b-hermes-q5_1.bin"`)
